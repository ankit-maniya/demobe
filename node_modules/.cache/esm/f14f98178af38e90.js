let express,models,Joi;_8af‍.x([["default",()=>_8af‍.o]]);_8af‍.w("express",[["default",["express"],function(v){express=v}]]);_8af‍.w("../models/index",[["default",["models"],function(v){models=v}]]);_8af‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);
...
Organization.get('/', async (req, res, next) => {
    try {
        ...
        _8af‍.g.console.log("All Company ====>",value);
