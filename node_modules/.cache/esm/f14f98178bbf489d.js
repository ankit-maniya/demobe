let express,models,Joi;_8bb‍.x([["default",()=>_8bb‍.o]]);_8bb‍.w("express",[["default",["express"],function(v){express=v}]]);_8bb‍.w("../models/index",[["default",["models"],function(v){models=v}]]);_8bb‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);
...
Organization.get('/', async (req, res, next) => {
    try {
        ...
        _8bb‍.g.console.log("All Company ====>",value);
